...
const Header = () => (
  <header className='header'>
    <div className='header__param'>
      <button className='header__param-bth'><i class="fas fa-sync"></i></button>
      <select className='header__select'>
        {['en', 'ru', 'be'].map(el => <option className='header__select-lang'>{el}</option>)}
      </select>
    ...
    <div className='header__searching'>
      ...
      <button className='header__searching-voice'><i class="fa fa-microphone" /></button>
